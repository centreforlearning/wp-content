<?php
/**
 * Template Name: Magadi Days Posts
 * Description: The template for displaying all Magadi Days posts.
 *
 * @package cfl
 */
...
if (has_post_thumbnail($ID)) {
    $thumb = wp_get_attachment_image_src(get_post_thumbnail_id($ID), 'parallax-bg');
    $valign = get_field('fimage_valign', $ID);
