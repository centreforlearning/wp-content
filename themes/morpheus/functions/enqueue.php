...
if ( ! function_exists( 'coll_enqueue_styles' ) ) {
	function coll_enqueue_styles() {
		...
		// wp_register_style( 'googlefonts', '//fonts.googleapis.com/css?family=Bentham|Pinyon+Script|Bitter:400,700|Raleway:300,400,500,600|Sacramento|Lato:300,400,900|Open+Sans:400,700,800|Pacifico|Lobster|Roboto:400,900,700|Oswald:400,700' );  Shane
