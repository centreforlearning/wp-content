...
class Su_Generator {
	...
	public static function button( $args = array() ) {
		...
		$args = wp_parse_args( $args, array(
				...
				'class'     => 'button',
				'icon'      => get_template_directory_uri() . '/functions/sc_generator/assets/images/icon.png',
				'echo'      => true,
				'shortcode' => false
			) );
		// Prepare icon
...
?>
				...
				<input type="hidden" name="su-generator-selected" id="su-generator-selected" value="<?php echo get_template_directory_uri() . '/functions/sc_generator/'; ?>" />
				<input type="hidden" name="su-generator-url" id="su-generator-url" value="<?php echo get_template_directory_uri() . '/functions/sc_generator/'; ?>" />
